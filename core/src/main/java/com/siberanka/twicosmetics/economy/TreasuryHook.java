...
public class TreasuryHook implements EconomyHook {
    ...
    private final Cause<NamespacedKey> cause = Cause.plugin(NamespacedKey.of("TwiCosmetics", "TreasuryHook"));
    private final Currency currency;

    public TreasuryHook(TwiCosmetics ultraCosmetics, String currencyName) {
