...
public class MainListener implements Listener {
    ...
    private static final NamespacedKey PET_COOLDOWN = new NamespacedKey(TwiCosmeticsData.get().getPlugin(), "pet_cooldown");
    ...
    public void onLeashBreak(EntityUnleashEvent event) {
        if (isPet(event.getEntity())) {
            ...
            TwiCosmeticsData.get().getPlugin().getScheduler().teleportAsync(entity, holder.getLocation());
