...
public class TreasureChestDesign {
    ...
    public TreasureChestDesign(String path) {
        ...
        String chestType = TwiCosmeticsData.get().getPlugin().getConfig().getString("TreasureChests.Designs." + path + ".chest-type");
        String effect = TwiCosmeticsData.get().getPlugin().getConfig().getString("TreasureChests.Designs." + path + ".effect");
        try {
