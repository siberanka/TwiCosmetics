...
public class StructureRollback implements Listener {
    private static final Set<StructureRollback> INSTANCES = ConcurrentHashMap.newKeySet();
    ...
    public StructureRollback(Area protectionArea) {
        ...
        Bukkit.getPluginManager().registerEvents(this, TwiCosmeticsData.get().getPlugin());
        INSTANCES.add(this);
    }
