...
public class SettingsManager {
    ...
    protected SettingsManager(String fileName) {
        File folder = new File(TwiCosmeticsData.get().getPlugin().getDataFolder(), "/data");
        if (!folder.exists()) {
            folder.mkdirs();
        }

        file = new File(TwiCosmeticsData.get().getPlugin().getDataFolder(), fileName + ".yml");
    ...
    public static CustomConfiguration getConfig() {
        return TwiCosmeticsData.get().getPlugin().getConfig();
    }
    ...
    public static boolean hasData(UUID uuid) {
        return Arrays.asList(TwiCosmeticsData.get().getPlugin().getDataFolder()
