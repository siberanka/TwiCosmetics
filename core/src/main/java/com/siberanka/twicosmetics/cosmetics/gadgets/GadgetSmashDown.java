...
public class GadgetSmashDown extends Gadget implements PlayerAffectingCosmetic, Updatable {
    ...
    public GadgetSmashDown(UltraPlayer owner, GadgetType type, TwiCosmetics ultraCosmetics) {
    ...
    protected void onRightClick() {
        ...
        gadgetTask = getTwiCosmetics().getScheduler().runAtEntityTimer(getPlayer(), () -> {
    ...
    public void onUpdate() {
        if (active && getPlayer().isOnGround()) {
            ...
            getTwiCosmetics().getScheduler().runAtEntityLater(getPlayer(), () -> active = false, 5);
            return;
        }
