...
public class DeathEffectFirework extends DeathEffect {
    ...
    public DeathEffectFirework(UltraPlayer owner, DeathEffectType type, TwiCosmetics ultraCosmetics) {
    ...
    public void displayParticles() {
        ...
        firework.setMetadata("uc_firework", new FixedMetadataValue(TwiCosmeticsData.get().getPlugin(), true));
        getTwiCosmetics().getScheduler().runAtLocationLater(player.getLocation(), firework::detonate, 5);
    }
}
