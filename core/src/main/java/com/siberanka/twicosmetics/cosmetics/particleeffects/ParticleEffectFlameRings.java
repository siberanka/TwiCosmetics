...
public class ParticleEffectFlameRings extends ParticleEffect {
    ...
    public ParticleEffectFlameRings(UltraPlayer owner, ParticleEffectType type, TwiCosmetics ultraCosmetics) {
    ...
    public void onUpdate() {
        for (int i = 0; i < 2; i++) {
            ...
            display.spawn(getPlayer().getLocation().add(0, 1, 0).add(v));
        }
        step += 3;
    }
}
