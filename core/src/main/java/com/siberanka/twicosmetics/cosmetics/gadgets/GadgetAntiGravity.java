...
public class GadgetAntiGravity extends Gadget implements PlayerAffectingCosmetic, Updatable {
    ...
    public GadgetAntiGravity(UltraPlayer owner, GadgetType type, TwiCosmetics ultraCosmetics) {
    ...
    protected void onRightClick() {
        ...
        as.setMetadata("NO_INTER", new FixedMetadataValue(getTwiCosmetics(), ""));
        ...
        getTwiCosmetics().getScheduler().runAtEntityLater(getPlayer(), () -> running = false, 240);
    }
