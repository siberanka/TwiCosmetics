...
public class GadgetBatBlaster extends Gadget implements PlayerAffectingCosmetic, Updatable {
    ...
    public GadgetBatBlaster(UltraPlayer owner, GadgetType type, TwiCosmetics ultraCosmetics) {
    ...
    protected void onRightClick() {
        ...
        this.bats = new EntitySpawner<>(EntityType.BAT, getPlayer().getEyeLocation(), 16, getTwiCosmetics());

        getTwiCosmetics().getScheduler().runAtEntityLater(getPlayer(), this::clean, 60);
    }
