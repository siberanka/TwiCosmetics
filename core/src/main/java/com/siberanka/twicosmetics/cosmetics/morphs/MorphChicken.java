...
public class MorphChicken extends Morph implements Updatable {
    ...
    public MorphChicken(UltraPlayer owner, MorphType type, TwiCosmetics ultraCosmetics) {
    ...
    public void onPlayerToggleSneak(PlayerToggleSneakEvent event) {
        ...
        getTwiCosmetics().getScheduler().runAtEntityLater(getPlayer(), () -> {
            ...
            getTwiCosmetics().getScheduler().runAtEntityLater(getPlayer(), this::onClear, 200);
        }, 50);
    }
    ...
    protected void onClear() {
        for (Chicken chicken : chickens) {
            flameDisplay.spawn(chicken.getLocation());
            chicken.remove();
        }
        chickens.clear();
    }
