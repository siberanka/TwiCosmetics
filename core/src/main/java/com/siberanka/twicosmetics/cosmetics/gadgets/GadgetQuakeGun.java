...
public class GadgetQuakeGun extends Gadget implements PlayerAffectingCosmetic {
    ...
    public GadgetQuakeGun(UltraPlayer owner, GadgetType type, TwiCosmetics ultraCosmetics) {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            for (Entity entity : nearbyEntities) {
                if ((entity instanceof Player || entity instanceof Creature)
                    ...
                    TwiCosmeticsData.get().getVersionManager().getModule().spawnFirework(location, FIREWORK_EFFECT);
                }
            }
        }
