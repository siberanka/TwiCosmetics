...
public class GadgetColorBomb extends Gadget implements PlayerAffectingCosmetic, Updatable {
    ...
    public GadgetColorBomb(UltraPlayer owner, GadgetType type, TwiCosmetics ultraCosmetics) {
    ...
    public void onUpdate() {
        ...
        if (!running && bomb.isOnGround()) {
            ...
            getTwiCosmetics().getScheduler().runAtEntityLater(bomb, this::onClear, 100);
        }
