...
import com.siberanka.twicosmetics.cosmetics.morphs.*;
...
public class MorphType extends CosmeticEntType<Morph> {
    ...
    public static void register() {
        VersionManager vm = TwiCosmeticsData.get().getVersionManager();
        ...
        if (vm.isUsingNMS()) {
            registerMorph("ElderGuardian", XMaterial.PRISMARINE_CRYSTALS, XEntityType.ELDER_GUARDIAN, TwiCosmeticsData.get().getVersionManager().getModule().getElderGuardianClass());
        }
