...
public class GadgetChristmasTree extends Gadget implements Updatable {
    ...
    public GadgetChristmasTree(UltraPlayer owner, GadgetType type, TwiCosmetics ultraCosmetics) {
    ...
    public void onRightClick() {
        ...
        active = true;
        getTwiCosmetics().getScheduler().runAtEntityLater(getPlayer(), () -> active = false, 200);
    }
