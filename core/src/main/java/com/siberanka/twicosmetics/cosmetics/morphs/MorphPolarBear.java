...
public class MorphPolarBear extends MorphLeftClickCooldown implements Updatable {
    ...
    public MorphPolarBear(UltraPlayer owner, MorphType type, TwiCosmetics ultraCosmetics) {
    ...
    public void onUpdate() {
        ...
        for (int i = 0; i < 3; i++) {
            TwiCosmeticsData.get().getVersionManager().getEntityUtil().sendBlizzard(getPlayer(), location, ent -> false, vector);
        }
