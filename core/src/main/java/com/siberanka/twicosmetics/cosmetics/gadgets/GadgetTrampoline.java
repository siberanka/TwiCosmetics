...
public class GadgetTrampoline extends Gadget implements Updatable {
    ...
    public GadgetTrampoline(UltraPlayer owner, GadgetType type, TwiCosmetics ultraCosmetics) {
    ...
    protected void onRightClick() {
        ...
        getTwiCosmetics().getScheduler().teleportAsync(getPlayer(), getPlayer().getLocation().add(0, 4, 0));
    ...
    private void generateStructure() {
        ...
        getTwiCosmetics().getScheduler().runAtEntityLater(getPlayer(), this::clearBlocks, 240);
    }
