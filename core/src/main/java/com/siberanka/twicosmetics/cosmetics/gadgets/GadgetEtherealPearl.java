...
public class GadgetEtherealPearl extends Gadget implements Updatable {
    ...
    public GadgetEtherealPearl(UltraPlayer owner, GadgetType type, TwiCosmetics ultraCosmetics) {
    ...
    public void onEquip() {
        super.onEquip();
        getTwiCosmetics().getEntityDismountListener().addHandler(this, this::onEntityDismount);
    }
    ...
    protected void onRightClick() {
        ...
        //getTwiCosmetics().getScheduler().teleportAsync(getPlayer(), getPlayer().getLocation().add(0, 5, 0));
    ...
    private void endRide() {
        ...
        if (lastLoc != null) {
            ...
            if (BlockUtils.isAir(target.getBlock().getType())) {
                getTwiCosmetics().getScheduler().teleportAsync(getPlayer(), target);
            }
        }
