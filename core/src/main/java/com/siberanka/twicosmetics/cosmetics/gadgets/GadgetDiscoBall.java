...
public class GadgetDiscoBall extends Gadget implements PlayerAffectingCosmetic, Updatable {
    ...
    public GadgetDiscoBall(UltraPlayer owner, GadgetType type, TwiCosmetics ultraCosmetics) {
    ...
    protected void onRightClick() {
        ...
        armorStand.setMetadata("NO_INTER", new FixedMetadataValue(getTwiCosmetics(), ""));
        ...
        running = true;
        getTwiCosmetics().getScheduler().runAtEntityLater(getPlayer(), this::clean, 400);
    }
