...
public class PlayerData {
    ...
    public PlayerData copy() {
        ...
        copy.keys = keys;
        copy.gadgetsEnabled = gadgetsEnabled;
        copy.morphSelfView = morphSelfView;
        copy.treasureNotifications = treasureNotifications;
        copy.filterByOwned = filterByOwned;
        copy.petNames = new HashMap<>(petNames);
        copy.ammo = new HashMap<>(ammo);
        copy.enabledCosmetics = new HashMap<>(enabledCosmetics);
        copy.unlockedCosmetics = new HashSet<>(unlockedCosmetics);
        return copy;
    }
    ...
    public void loadFromFile() {
        ...
        if (TwiCosmeticsData.get().areCosmeticsProfilesEnabled() && sm.fileConfiguration.isConfigurationSection("enabled")) {
    ...
    public void loadFromSQL() {
        TwiCosmeticsData data = TwiCosmeticsData.get();
    ...
    public void saveToSQL() {
        MySqlConnectionManager sql = TwiCosmeticsData.get().getPlugin().getMySqlConnectionManager();
        PlayerDataTable pd = sql.getPlayerData();
